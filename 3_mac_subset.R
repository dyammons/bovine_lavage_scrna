...
#remove low quality cells (c8; very high MT enrichment) contaminating T cells (c11) and contaminating B cells (c12) - note c1 in this does look a little susspect
seu.obj <- subset(seu.obj, invert = T, subset = clusterID_integrated.harmony %in% c(8, 11, 12))
...
vilnPlots(seu.obj = seu.obj, groupBy = "clusterID_sub_integrated", outName = outName,
